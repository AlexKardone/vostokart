...
// if ($_GET['dev'] == 'Y')
//  {
// foreach($arResult["PROPERTIES"]["MORE_PHOTO"]["VALUE"] as $key => $PHOTO_RESIZED) {
//    $file = CFile::ResizeImageGet($PHOTO_RESIZED, array("width" => 210, "height" => 210), BX_RESIZE_IMAGE_EXACT, true);
// $file['src']
