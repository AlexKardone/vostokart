...
class Panchang {
  ...
  public function moonLongitude($d) {
	...
	echo "LON - ".$lon." REV->lon = ".$this->REV($lon);
  ...
  public function calcPanchanga($dd, $mm, $yy, $hr, $zhr)
  {
    ...
    echo "d = ".$d." hr = ".$hr." zhr = ".$zhr."<br>";
    echo "<br> slon arg = ".($d+(($hr-$zhr)/24.0))." slon = ".$slon." mlon = ".$mlon."<br><br>";
    ...
    echo "hr = ".$hr."zhr = ".$zhr."TMLON = ".$tmlon." TSLON = ".$tslon."<br>";
    if($n<=14){
      $pdata['aksha'] = "Shukla"; 
    }
    else {
