...
<div class="content_center">
    <section class="block_arrivals_all">
      ...
      <menu class="bread_crumbs"><a href="/">Главная</a> <span>/</span> Ожидаемое</menu>
      <h1>Ожидаемое</h1>

<?$APPLICATION->IncludeComponent("bitrix:catalog.section", "grid", Array(
	"IBLOCK_TYPE" => "xmlcatalog",	// Тип инфоблока
	"IBLOCK_ID" => "8",	// Инфоблок
	"SECTION_ID" => "482",	// ID раздела
