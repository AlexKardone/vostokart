...
$APPLICATION->SetPageProperty("description", "Информация по гарантии при покупке мебели и предметов интерьера в галерее \"Интерьеры Махараджей\"");
$APPLICATION->SetPageProperty("title", "Гарантия на мебель и предметы интерьера");
