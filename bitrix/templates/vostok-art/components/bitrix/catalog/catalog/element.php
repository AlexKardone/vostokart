		...
		<div class="col-md-8">
			...
			$ElementID = $APPLICATION->IncludeComponent(
				...
				array(
					...
					"META_KEYWORDS" => $arParams["PROPERTY_VALUES"]["ELEMENT_PAGE_KEYWORDS"],
					"META_DESCRIPTION" => $arParams["PROPERTY_VALUES"]["ELEMENT_PAGE_DESCRIPTION"],
					"BROWSER_TITLE" => $arParams["PROPERTY_VALUES"]["ELEMENT_PAGE_TITLE"],
