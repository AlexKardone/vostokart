...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="content-wrap catalog-hack">
				<?
				...
				if (in_array($arResult['VARIABLES']['SECTION_CODE'], $manual_sections))
				{
				...
				"PROPERTY_CODE" => '31',
				"PROPERTIES" => "PROPERTY_SECTION_FIELDS",
				"SECTION_FIELDS" => array(
				0 => "UF_SITE_VIEW",1=>"PICTURE",
				),
