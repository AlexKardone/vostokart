...
if(CModule::IncludeModule("iblock"))
 {
  ...
  $db_list = CIBlockSection::GetList(Array($by=>$order), $arFilter, true, Array('UF_SITE_VIEW'));
...
$arResult['meta_description']=$arResult['NAME'] .' - Каталог товаров из Индии, Японии и Тайланда';
$APPLICATION->SetPageProperty("description", $arResult['meta_description']);

if ($_GET['dev'] == 'Y'){
// $arResult['PROPERTIES']['SKIDKA']['NAME']
// echo "<pre>";
// print_r($arResult);
// echo "</pre>";
// die;
