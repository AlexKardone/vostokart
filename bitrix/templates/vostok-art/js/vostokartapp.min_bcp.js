/*
 * vostokartapp Responsive Library
...
(function(e, t, n, r) {
    ...
    i(["vostokartapp-mq-small", "vostokartapp-mq-medium", "vostokartapp-mq-large", "vostokartapp-mq-xlarge", "vostokartapp-mq-xxlarge", "vostokartapp-data-attribute-namespace"]), e(function() {
    ...
    t.matchMedia = t.matchMedia || function(e) {
        ...
        function(e) {
        ...
        }(jQuery), t.vostokartapp = {
            name: "vostokartapp",
            version: "5.2.2",
            media_queries: {
                small: s(".vostokartapp-mq-small").css("font-family").replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ""),
                medium: s(".vostokartapp-mq-medium").css("font-family").replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ""),
                large: s(".vostokartapp-mq-large").css("font-family").replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ""),
                xlarge: s(".vostokartapp-mq-xlarge").css("font-family").replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ""),
                xxlarge: s(".vostokartapp-mq-xxlarge").css("font-family").replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, "")
            },
            ...
            set_namespace: function() {
                var t = this.global.namespace === r ? e(".vostokartapp-data-attribute-namespace").css("font-family") : this.global.namespace;
            ...
            utils: {
                ...
                data_options: function(t) {
                    ...
                    var n = {},
                        r, i, s, o = function(e) {
                            var t = vostokartapp.global.namespace;
                ...
                register_media: function(t, n) {
                    vostokartapp.media_queries[t] === r && (e("head").append('<meta class="' + n + '">'), vostokartapp.media_queries[t] = l(e("." + n).css("font-family")))
                },
                add_custom_rule: function(e, t) {
                    if (t === r && vostokartapp.stylesheet) vostokartapp.stylesheet.insertRule(e, vostokartapp.stylesheet.cssRules.length);
                    else {
                        var n = vostokartapp.media_queries[t];
                        n !== r && vostokartapp.stylesheet.insertRule("@media " + vostokartapp.media_queries[t] + "{ " + e + " }")
                    }
                },
        ...
        }, e.fn.vostokartapp = function() {
            var e = Array.prototype.slice.call(arguments, 0);
            return this.each(function() {
                return vostokartapp.init.apply(vostokartapp, [this].concat(e)), this
            })
        }
})
...
function(e, t, n, r) {
    ...
    vostokartapp.libs.interchange = {
        ...
        settings: {
            ...
            named_queries: {
                "default": "only screen",
                small: vostokartapp.media_queries.small,
                medium: vostokartapp.media_queries.medium,
                large: vostokartapp.media_queries.large,
                xlarge: vostokartapp.media_queries.xlarge,
                xxlarge: vostokartapp.media_queries.xxlarge,
        ...
        init: function(t, n, r) {
            vostokartapp.inherit(this, "throttle random_str"), this.data_attr = this.set_data_attr(), e.extend(!0, this.settings, n, r), this.bindings(n, r), this.load("images"), this.load("nodes")
        },
...
function(e, t, n, r) {
    ...
    vostokartapp.libs.dropdown = {
        ...
        init: function(e, t, n) {
            vostokartapp.inherit(this, "throttle"), this.bindings(t, n)
        },
        events: function(n) {
            var r = this,
                i = r.S;
        ...
        close: function(e) {
            var t = this;
            e.each(function() {
                t.S(this).hasClass(t.settings.active_class) && (t.S(this).css(vostokartapp.rtl ? "right" : "left", "-99999px").removeClass(t.settings.active_class).prev("[" + t.attr_name() + "]").removeClass(t.settings.active_class), t.S(this).trigger("closed", [e]))
            })
        },
        closeall: function() {
            var t = this;
        ...
        css: function(e, t) {
            ...
            if (this.small()) {
                ...
                e.attr("style", "").removeClass("drop-left drop-right drop-top").css({
                    ...
                    "max-width": "none",
                    top: n.top
                }), e.css(vostokartapp.rtl ? "right" : "left", "2.5%")
            } else {
        ...
        dirs: {
            ...
            top: function(e, t) {
                var n = vostokartapp.libs.dropdown,
                    r = n.dirs._base.call(this, e),
                    i = e.outerWidth() / 2 - 8;
                return this.addClass("drop-top"), (e.outerWidth() < this.outerWidth() || n.small()) && n.adjust_pip(i, r), vostokartapp.rtl ? {
            ...
            left: function(e, t) {
                var n = vostokartapp.libs.dropdown.dirs._base.call(this, e);
        ...
        clear_idx: function() {
            var e = vostokartapp.stylesheet;
            this.rule_idx && (e.deleteRule(this.rule_idx), e.deleteRule(this.rule_idx), delete this.rule_idx)
        },
        small: function() {
            return matchMedia(vostokartapp.media_queries.small).matches && !matchMedia(vostokartapp.media_queries.medium).matches
        },
        off: function() {
...
function(e, t, n, r) {
    ...
    vostokartapp.libs["magellan-expedition"] = {
        ...
        init: function(f, g, e) {
            vostokartapp.inherit(this, "throttle");
            this.bindings(g, e)
        },
        events: function() {
            var e = this,
            ...
            f(e.scope).off(".magellan").on("click.fndtn.magellan", "[" + e.add_namespace("data-magellan-arrival") + '] a[href^="#"]', function(m) {
                m.preventDefault();
                var l = c(this).closest("[" + e.attr_name() + "]"),
                    i = l.data("magellan-expedition-init");
                var k = this.hash.split("#").join(""),
                    j = c("a[name='" + k + "']");
                if (j.length === 0) {
                    j = c("#" + k)
                }
            ...
            }).on("scroll.fndtn.magellan", e.throttle(this.check_for_arrivals.bind(this), g.throttle_delay));
            c(b).on("resize.fndtn.magellan", e.throttle(this.set_expedition_position.bind(this), g.throttle_delay))
        },
        check_for_arrivals: function() {
            var e = this;
            e.update_arrivals();
            e.update_expedition_positions()
        },
        set_expedition_position: function() {
            var e = this;
            c("[" + this.attr_name() + "=fixed]", e.scope).each(function(f, h) {
                var j = c(this),
                    i = j.attr("styles"),
                    g;
                j.attr("style", "");
                g = j.offset().top;
                j.data(e.data_attr("magellan-top-offset"), g);
                j.attr("style", i)
            })
        },
        update_expedition_positions: function() {
            var f = this,
                e = c(b).scrollTop();
            c("[" + this.attr_name() + "=fixed]", f.scope).each(function() {
                var h = c(this),
                    g = h.data("magellan-top-offset");
                if (e >= g) {
                    var j = h.prev("[" + f.add_namespace("data-magellan-expedition-clone") + "]");
                    if (j.length === 0) {
                        j = h.clone();
                        j.removeAttr(f.attr_name());
                        j.attr(f.add_namespace("data-magellan-expedition-clone"), "");
                        h.before(j);
                        var i = c(".hiddenlogo");
                        if (i.length > 0) {
                            i.animate({
                    ...
                    h.prev("[" + f.add_namespace("data-magellan-expedition-clone") + "]").remove();
                    h.attr("style", "");
                    var i = c(".hiddenlogo");
                    if (i.length > 0) {
        ...
        update_arrivals: function() {
            var f = this,
                e = c(b).scrollTop();
            c("[" + this.attr_name() + "]", f.scope).each(function() {
                var k = c(this),
                    g = g = k.data(f.attr_name(true) + "-init"),
                    i = f.offsets(k, e),
                    j = k.find("[" + f.add_namespace("data-magellan-arrival") + "]"),
                    h = false;
                i.each(function(l, m) {
                    if (m.viewport_offset >= m.top_offset) {
                        var n = k.find("[" + f.add_namespace("data-magellan-arrival") + "]");
                        n.not(m.arrival).removeClass(g.active_class);
                        m.arrival.addClass(g.active_class);
                        h = true;
                        return true
                    }
                });
        ...
        offsets: function(i, e) {
            var f = this,
                g = i.data(f.attr_name(true) + "-init"),
                h = e;
            return i.find("[" + f.add_namespace("data-magellan-arrival") + "]").map(function(j, n) {
                var m = c(this).data(f.data_attr("magellan-arrival")),
                    l = c("[" + f.add_namespace("data-magellan-destination") + "=" + m + "]");
                if (l.length > 0) {
                    var k = l.offset().top - g.destination_threshold - i.outerHeight();
                    return {
                        destination: l,
                        arrival: c(this),
                        top_offset: k,
        ...
        reflow: function() {
            var e = this;
            c("[" + e.add_namespace("data-magellan-expedition-clone") + "]", e.scope).remove()
        }
    }
}(jQuery, this, this.document)),
function(e, t, n, r) {
                ...
                if (typeof n == "undefined" || !n.url) o.length > 0 && this.hide(o, s.css.close), this.show(i, s.css.open);
                    ...
                    e.extend(n, {
                        success: function(t, n, a) {
                            e.isFunction(u) && u(t, n, a), i.html(t), r.S(i).vostokartapp("section", "reflow"), o.length > 0 && r.hide(o, s.css.close), r.show(i, s.css.open)
                        }
                    }), e.ajax(n)
                }
            }
    ...
    vostokartapp.libs.tooltip = {
        ...
        settings: {
            ...
            tip_template: function(e, t) {
                return '<span data-selector="' + e + '" class="' + vostokartapp.libs.tooltip.settings.tooltip_class.substring(1) + '">' + t + '<span class="nub"></span></span>'
            }
        },
        cache: {},
        init: function(e, t, n) {
            vostokartapp.inherit(this, "random_str"), this.bindings(t, n)
        },
        events: function(t) {
            var n = this,
                r = n.S;
        ...
        reposition: function(t, n, r) {
            ...
            if (this.small()) f(n, t.offset().top + t.outerHeight() + 10, "auto", "auto", 12.5, e(this.scope).width()), n.addClass("tip-override"), f(s, -o, "auto", "auto", t.offset().left);
                ...
                var l = t.offset().left;
                vostokartapp.rtl && (s.addClass("rtl"), l = t.offset().left + t.outerWidth() - n.outerWidth()), f(n, t.offset().top + t.outerHeight() + 10, "auto", "auto", l), n.removeClass("tip-override"), r && r.indexOf("tip-top") > -1 ? (vostokartapp.rtl && s.addClass("rtl"), f(n, t.offset().top - n.outerHeight(), "auto", "auto", l).removeClass("tip-override")) : r && r.indexOf("tip-left") > -1 ? (f(n, t.offset().top + t.outerHeight() / 2 - n.outerHeight() / 2, "auto", "auto", t.offset().left - n.outerWidth() - o).removeClass("tip-override"), s.removeClass("rtl")) : r && r.indexOf("tip-right") > -1 && (f(n, t.offset().top + t.outerHeight() / 2 - n.outerHeight() / 2, "auto", "auto", t.offset().left + t.outerWidth() + o).removeClass("tip-override"), s.removeClass("rtl"))
            }
...
function(e, t, n, r) {
    ...
    vostokartapp.libs.clearing = {
        ...
        init: function(e, t, n) {
            var r = this;
            vostokartapp.inherit(this, "throttle image_loaded"), this.bindings(t, n), r.S(this.scope).is("[" + this.attr_name() + "]") ? this.assemble(r.S("li", this.scope)) : r.S("[" + this.attr_name() + "]", this.scope).each(function() {
        ...
        events: function(r) {
            ...
            e(".scroll-container").length > 0 && (this.scope = e(".scroll-container")), s(this.scope).off(".clearing").on("click.fndtn.clearing", "ul[" + this.attr_name() + "] li", function(e, t, n) {
                ...
                vostokartapp.libs.clearing.close(e, this)
        ...
        assemble: function(t) {
            ...
            n.after('<div id="vostokartappClearingHolder"></div>');
            var r = n.detach(),
                i = "";
            if (r[0] == null) return;
            i = r[0].outerHTML;
            var s = this.S("#vostokartappClearingHolder"),
...
function(e, t, n, r) {
    ...
    vostokartapp.libs.joyride = {
        ...
        init: function(t, n, r) {
            vostokartapp.inherit(this, "throttle random_str"), this.settings = this.settings || e.extend({}, this.defaults, r || n), this.bindings(n, r)
        },
        events: function() {
            var n = this;
...
function(e, t, n, r) {
    ...
    var i = function() {},
        s = function(r, i) {
            ...
            s.cache = {}, s.slides = function() {
                ...
                s.build_markup(), i.timer && (s.cache.timer = s.create_timer(), vostokartapp.utils.image_loaded(this.slides().children("img"), s.cache.timer.start)), d = new u(i, f);
                if (m) {
                ...
                vostokartapp.utils.image_loaded(l, s.compute_dimensions), vostokartapp.utils.image_loaded(l, function() {
    ...
    vostokartapp.libs = vostokartapp.libs || {}, vostokartapp.libs.orbit = {
        name: "orbit",
        version: "5.2.2",
        settings: {
            animation: "slide",
...
function(e, t, n, r) {
    ...
    vostokartapp.libs.topbar = {
        ...
        init: function(t, n, r) {
            vostokartapp.inherit(this, "add_custom_rule register_media throttle");
            var i = this;
            i.register_media("topbar", "vostokartapp-mq-topbar"), this.bindings(n, r), i.S("[" + this.attr_name() + "]", this.scope).each(function() {
                var t = e(this),
        ...
        breakpoint: function() {
            return !matchMedia(vostokartapp.media_queries.topbar).matches
        },
        small: function() {
            return matchMedia(vostokartapp.media_queries.small).matches
        },
        medium: function() {
            return matchMedia(vostokartapp.media_queries.medium).matches
        },
        large: function() {
            return matchMedia(vostokartapp.media_queries.large).matches
        },
        assemble: function(t) {
            var n = this,
