...
$APPLICATION->SetPageProperty("description", "Подробное руководство, как оформить, подтвердить и оплатить заказ в галерее \"Интерьеры Махараджей\"");
$APPLICATION->SetPageProperty("title", "Как купить - оформление и оплата заказа");
